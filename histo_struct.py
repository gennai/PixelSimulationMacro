...
from rechit_helpers import NotModuleEdge, NotModuleEdgePhase2, CmToUm, ToKe, ELossSilicon
...
#########################
    ...
    ###########################################################################################
        ...
        for i in xrange(V_nbins):
            ...
            self.resXvsNx_qlow_inVBinTH2.append( ROOT.TH2F(hname,htitle,75,-150.,150.,4,0.5,4.5))
            ...
            self.resXvsNx_qhigh_inVBinTH2.append( ROOT.TH2F(hname,htitle,75,-150.,150.,4,0.5,4.5))
        ...
        for i in xrange(V_nbins):
            ...
            self.resYvsNy_qlow_inVBinTH2.append( ROOT.TH2F(hname,htitle,75,-150.,150.,5,0.5,5.5))
            ...
            self.resYvsNy_qhigh_inVBinTH2.append( ROOT.TH2F(hname,htitle,75,-150.,150.,5,0.5,5.5))
    ...
    def DrawAllCanvas(self, Qave, mpv_theory,plotDir):
    ##############################
        ...
        mylegX.Draw("same")
        c1_spreadXall.SaveAs(plotDir+"/c1_spreadXall.pdf")
        c1_spreadXall.SaveAs(plotDir+"/c1_spreadXall.root")   
   
        c1_stack_spreadXall.cd()
        stack_spreadXall.Draw()
        stack_spreadXall.SetMaximum(1.2)
        mylegXstack.Draw("same")
        c1_stack_spreadXall.SaveAs(plotDir+"/c1_spreadXall_stack.pdf")
        ...
        mylegY.Draw("same")
        c1_spreadYall.SaveAs(plotDir+"/c1_spreadYall.pdf")
        c1_spreadYall.SaveAs(plotDir+"/c1_spreadYall.root")
        
        c1_stack_spreadYall.cd()
        stack_spreadYall.Draw()
        stack_spreadYall.SetMaximum(1.2)
        mylegYstack.Draw("same")
        c1_stack_spreadYall.SaveAs(plotDir+"/c1_spreadYall_stack.pdf")
        ...
        mylegX.Draw("same")
        c1_spreadXhigh.SaveAs(plotDir+"/c1_spreadXhigh.pdf")
        c1_spreadXhigh.SaveAs(plotDir+"/c1_spreadXhigh.root")

        c1_stack_spreadXhigh.cd()
        stack_spreadXhigh.Draw()
        stack_spreadXhigh.SetMaximum(1.2)
        mylegXstack.Draw("same")
        c1_stack_spreadXhigh.SaveAs(plotDir+"/c1_spreadXhigh_stack.pdf")
        ...
        mylegY.Draw("same")
        c1_spreadYhigh.SaveAs(plotDir+"/c1_spreadYhigh.pdf")
        c1_spreadYhigh.SaveAs(plotDir+"/c1_spreadYhigh.root")

        c1_stack_spreadYhigh.cd()
        stack_spreadYhigh.Draw()
        stack_spreadYhigh.SetMaximum(1.2)
        mylegYstack.Draw("same")
        c1_stack_spreadYhigh.SaveAs(plotDir+"/c1_spreadYhigh_stack.pdf")
        ...
        mylegX.Draw("same")
        c1_spreadXlow.SaveAs(plotDir+"/c1_spreadXlow.pdf")
        c1_spreadXlow.SaveAs(plotDir+"/c1_spreadXlow.root")

        c1_stack_spreadXlow.cd()
        stack_spreadXlow.Draw()
        stack_spreadXlow.SetMaximum(1.2)
        mylegXstack.Draw("same")
        c1_stack_spreadXlow.SaveAs(plotDir+"/c1_spreadXlow_stack.pdf")
        ...
        mylegY.Draw("same")
        c1_spreadYlow.SaveAs(plotDir+"/c1_spreadYlow.pdf")
        c1_spreadYlow.SaveAs(plotDir+"/c1_spreadYlow.root")

        c1_stack_spreadYlow.cd()
        stack_spreadYlow.Draw()
        stack_spreadYlow.SetMaximum(1.2)
        mylegYstack.Draw("same")
        c1_stack_spreadYlow.SaveAs(plotDir+"/c1_spreadYlow_stack.pdf")
        ...
        # save the canvas
        c1_qclus.SaveAs(plotDir+"/c1_qclus_in%sBin.pdf" % self.the_name)
        c1_qclus_primaries_corr.SaveAs(plotDir+"/c1_qclus_primaries_corr_in%sBin.pdf" % self.the_name)
        c1_spreadXY.SaveAs(plotDir+"/c1_spreadXY_in%sBin.pdf" % self.the_name)
        c1_primaries_spreadXY.SaveAs(plotDir+"/c1_primaries_spreadXY_in%sBin.pdf" % self.the_name)
        c1_alphabeta.SaveAs(plotDir+"/c1_alphabeta_in%sBin.pdf" % self.the_name)
        ...
        #c1_rPhi_qall.SaveAs(plotDir+"/c1_rPhi_qall_in%sBin.pdf" % self.the_name)
        c1_rPhi_qlow.SaveAs(plotDir+"/c1_rPhi_qlow_in%sBin.pdf" % self.the_name)
        c1_rPhi_qhigh.SaveAs(plotDir+"/c1_rPhi_qhigh_in%sBin.pdf" % self.the_name)
        c1_rPhiVsNx_qlow.SaveAs(plotDir+"/c1_rPhiVsNx_qlow_in%sBin.pdf" % self.the_name)
        ...
        c1_zVsrPhi_qlow.SaveAs(plotDir+"/c1_zVsrPhi_qlow_in%sBin.pdf" % self.the_name)
        c1_zVsrPhi_qhigh.SaveAs(plotDir+"/c1_zVsrPhi_qhigh_in%sBin.pdf" % self.the_name)
        ...
        lego.Draw("same")
        cResVsV_1.SaveAs(plotDir+"/rmsVs%s_rphi.root" % self.the_name)
        ...
        lego.Draw("same")
        cResVsV_2.SaveAs(plotDir+"/rmsVs%s_rz.root" % self.the_name)
        ...
        cMPVnormVsV.SaveAs(plotDir+"/mpv_norm_Vs%s.root" % self.the_name)        
